...
import { NO_LIMIT_TRAIN_STATUS } from '../../types';
...
const isDeleteDisable = (project: TrainingProject, trainingStatus: Status) => {
  if (project.category === 'modelzoo') return false;
    ...
    <>
      <Stack className={classes.root} onClick={onSelectedProject}>
        ...
        <Stack styles={{ root: { padding: '10px 20px 20px' } }}>
          ...
          >
            ...
            {project.category === 'modelzoo' && 'By Intel'}
          </Label>
          ...
          {project.category === 'modelzoo' && <Stack horizontal tokens={{ childrenGap: '5px' }} wrap></Stack>}
      ...
      >
        <DialogFooter styles={{ actionsRight: { textAlign: 'left' } }}>
          <PrimaryButton text="Delete" onClick={onModelDelete} />
