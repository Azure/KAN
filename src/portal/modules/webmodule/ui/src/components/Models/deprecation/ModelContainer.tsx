...
import AddCustomVisionContainer from './AddCustomVisionContainer';
...
const ModelContainer = () => {
  ...
  const trainingProjectList = useSelector(trainingProjectModelFactory('customvision'));
      ...
      >
        ...
        <Stack tokens={{ childrenGap: '65px' }}>
          ...
          {isAddIntelOvms ? (
            <OpenVinoDashboard
              intelProjectList={[]}
              openVinoProjectList={trainingProjectList.filter((project) => project.category === 'modelzoo')}
