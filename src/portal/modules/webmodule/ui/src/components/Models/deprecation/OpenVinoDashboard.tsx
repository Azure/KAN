...
import Tag from '../Tag';
import AddOpenVinoPanel from './AddOpenVinoPanel';

const CARD_PART_LIMIT = 5;

interface Props {
  intelProjectList: any[];
...
const isDisableAddButton = (intel: any, openVinoList: TrainingProject[]) => {
...
const getFilterProjects = (projects: any[], input: string) => {
...
const IntelProjectDashboard = (props: Props) => {
  ...
  const [localProjectList, setLocalProjectList] = useState<any[]>(intelProjectList);
